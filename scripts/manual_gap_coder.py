...
st.set_page_config(page_title="Manual Gap Coder", layout="wide", initial_sidebar_state="expanded")
...
SEVERITY_HELP = {
    3: {
        ...
        "examples": [
            ...
            '"We spent three days on a deliverable the client didn\'t ask for."',
        ],
    },
    2: {
        "title": "Hedged (2)",
        ...
        "examples": [
            '"It hasn\'t been the most sustainable few weeks, to be honest."',
...
def main() -> None:
    ...
    st.title("Manual disclosure gap coder")
    st.markdown(
